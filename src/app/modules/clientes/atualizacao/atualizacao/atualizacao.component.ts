  ...
  inicializarCliente() {
    ...
    this.clienteService.obtemClientePorId(this.idCliente).subscribe({
      next: (cliente: Cliente) => {
        ...
        if (this.cliente.endereco == null) this.cliente.endereco = {
          logradouro: '',
          numero: null,
          bairro: '',
          codigoPostal: '',
